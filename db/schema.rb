...
ActiveRecord::Schema.define(version: 20180805032910) do

  create_table "chanpagnes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["name"], name: "index_chanpagnes_on_name"
  end
